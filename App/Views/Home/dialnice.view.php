            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="progress mb-auto" role="progressbar" aria-valuenow="77" aria-valuemin="0"
                         aria-valuemax="100">
                        <div class="progress-bar progress-bar-success" role="progressbar" style="width: 77%;" aria-valuenow="77"
                             aria-valuemin="0" aria-valuemax="100">
    395,9 km
</div>
                        <div class="progress-bar progress-bar-warning" role="progressbar" style="width: 6%;" aria-valuenow="6"
                             aria-valuemin="0" aria-valuemax="100">
    28,4 km
</div>
                        <div class="progress-bar progress-bar-danger" role="progressbar" style="width: 17%;" aria-valuenow="17"
                             aria-valuemin="0" aria-valuemax="100">
    87,7 km
</div>
                    </div>
            ...
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="progress mb-auto">
                        <div class="progress-bar progress-bar-success" role="progressbar" style="width: 100%;" aria-valuenow="100"
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="progress mb-auto">
                        <div class="progress-bar progress-bar-success" role="progressbar" style="width: 63%;" aria-valuenow="63"
                             aria-valuemin="0" aria-valuemax="100">37,1 km
</div>
                        <div class="progress-bar progress-bar-danger" role="progressbar" style="width: 37%;" aria-valuenow="37"
        ...
        <div class="col-md-6">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <div class="progress mb-auto">
                        <div class="progress-bar progress-bar-success" role="progressbar" style="width: 67%;" aria-valuenow="67"
                             aria-valuemin="0" aria-valuemax="100">32 km
</div>
                        <div class="progress-bar progress-bar-danger" role="progressbar" style="width: 33%;" aria-valuenow="33"
